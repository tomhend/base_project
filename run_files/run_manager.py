...
class RunManager:
    def __init__(self, cfg: dict) -> None:
        ...
        metric_list = list(set(['loss_train_epoch', 'loss_val_epoch'] + self.cfg['session_cfg'].get('metrics', [])))
        self.metrics = Metrics(metric_list)
        self.selection_metric = self.cfg['session_cfg'].get('selection_metric', 'loss_val_epoch')
